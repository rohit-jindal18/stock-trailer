...
export default function Authorize() {
  ...
  const { data, error, isLoading, user } = useSWR('/api/user');
  console.log("dara", data, error, isLoading, user);
  return (
    <>
      <Head>
      ...
      <main className={styles.main}>
        ...
        <Box mt={'32px'}>
          ...
          <Box>
            ...
            <Button variant={'solid'} mt={'16px'} onClick={submitEntries}>Submit</Button>
          </Box>
        </Box>
      </main>
    </>
