...
export class QuickShortStrategy extends BaseStrategy {
    ...
    protected initialize(): void {
        ...
        console.log("setup");
        scheduleJob('00 27 16 * * *', (fireDate: Date) => {
            console.log("scheduleJob 00 17 16 * * *")
    ...
    setupInstruments() {
        console.log("setup isntrument", QSMemoryCache, QSMemoryCache.getQSInstruments());
        this.instruments = QSMemoryCache.getQSInstruments();
        console.log("cache", this.instruments);
        this.buildShortMap();
