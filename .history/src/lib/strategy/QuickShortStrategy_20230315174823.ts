...
export class QuickShortStrategy extends BaseStrategy {
    ...
    protected initialize(): void {
        ...
        console.log("setup");
        scheduleJob('00 46 17 * * *', (fireDate: Date) => {
    ...
    buildShortMap = () => {
        Array.from(this.instruments).forEach(d => {
            SHORTS_MAP[d.instrumentId] = d;
        })
    }
    ...
    setupInstruments() {
        ...
        Array.from(this.instruments || []).map((instrument: ShortInstrumentPayload) => {
